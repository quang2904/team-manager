...
import { PermissionsEnum, IHelpCenterArticle } from 'contracts';
...
import { Permissions, CrudController, TenantPermissionGuard, PermissionGuard, UUIDValidationPipe } from 'src/core';
