...
import { ExtensionPlugin, OnDefaultPluginSeed, OnRandomPluginSeed } from 'plugin';
...
export class KnowledgeBasePlugin
  implements IOnPluginBootstrap, IOnPluginDestroy, OnDefaultPluginSeed, OnRandomPluginSeed
{
