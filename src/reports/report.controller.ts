import { GetReportMenuItemsInput, IPagination, UpdateReportMenuInput } from 'contracts';
...
export class ReportController {
  ...
  @Get()
  async findAll(@Query() options: FindManyOptions<Report>): Promise<IPagination<Report>> {
