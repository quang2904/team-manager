...
import { IOrganization, ITenant, JobPostSourceEnum } from 'contracts';
...
const insertOccupations = async (dataSource: DataSource, occupations: JobSearchOccupation[]): Promise<void> => {
