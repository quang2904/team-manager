...
import { IGetJobPresetCriterionInput, IJobPreset, IMatchingCriterions } from 'contracts';
import { GauzyAIService } from 'plugins/integration-ai';
...
export class JobSearchPresetController {
  ...
  async getAll(@Query() input: JobPresetQuerDTO) {
