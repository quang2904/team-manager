...
import { IJobPresetUpworkJobSearchCriterion, JobPostTypeEnum } from 'contracts';
import {
  JobPreset,
  JobSearchCategory,
  JobSearchOccupation,
  ...
  implements IJobPresetUpworkJobSearchCriterion
{
  ...
  @ManyToOne(() => JobSearchOccupation, (occupation) => occupation.jobPresetCriterions)
  ...
  @ManyToOne(() => JobSearchCategory, (category) => category.jobPresetCriterions)
