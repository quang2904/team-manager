...
import { IEmployeePresetInput, IGetMatchingCriterions, IMatchingCriterions } from 'contracts';
...
export class EmployeePresetController {
  ...
  @Get(':employeeId')
  async getEmployeePreset(@Param('employeeId', UUIDValidationPipe) employeeId: string) {
