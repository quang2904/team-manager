...
export class EmployeeJobPostController {
  ...
  @Post('apply')
  async apply(@Body() input: IEmployeeJobApplication, @Headers() headers: Record<string, string>) {
  ...
  @UsePipes(new ValidationPipe())
  @Post('updateApplied')
  async updateApplied(@Body() input: IEmployeeJobApplication, @Headers() headers: Record<string, string>) {
  ...
  @Post('hide')
  async updateVisibility(@Body() data: IVisibilityJobPostInput, @Headers() headers: Record<string, string>) {
