...
import { IOrganization, IPagination, ITaskSize, ITaskSizeCreateInput, ITaskSizeFindInput, ITenant } from 'contracts';
...
export class TaskSizeService extends TaskStatusPrioritySizeService<TaskSize> {
   ...
   * @returns
   */
  async findTaskSizes(params: ITaskSizeFindInput): Promise<IPagination<ITaskSize>> {
    try {
