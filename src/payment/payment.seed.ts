...
import { IEmployee, IOrganization, ITenant, PaymentMethodEnum } from 'contracts';
...
export const createDefaultPayment = async (
  ...
  for (const organization of organizations) {
    ...
    for (const invoice of invoices) {
      ...
      payment.paymentMethod = faker.helpers.arrayElement(Object.keys(PaymentMethodEnum)) as PaymentMethodEnum;
