...
import { IProductOptionGroupTranslation, IProductOptionGroupTranslatable } from 'contracts';
...
export class ProductOptionGroupService extends TenantAwareCrudService<ProductOptionGroup> {
  ...
  async deleteBulk(productOptionGroupsInput: IProductOptionGroupTranslatable[]) {
    return this.productOptionGroupRepository.remove(productOptionGroupsInput as any);
  }
