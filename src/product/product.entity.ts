import { Entity, Column, OneToMany, RelationId, JoinColumn, ManyToOne, ManyToMany, JoinTable, Index } from 'typeorm';
import { ApiProperty, ApiPropertyOptional } from '@nestjs/swagger';
import { IsString, IsOptional } from 'class-validator';
import { IInvoiceItem, IImageAsset, IProductTranslatable, ITag, IWarehouse } from 'contracts';
import {
  ImageAsset,
  InvoiceItem,
  ProductCategory,
