import { FileStorageOption, FileStorageProviderEnum } from 'contracts';
      ...
      if (request && isNotEmpty(request['tenantSettings'])) {
        ...
        if (isEmpty(provider) || !providers.includes(provider)) {
          this.config.provider =
            (environment.fileSystem.name.toUpperCase() as FileStorageProviderEnum) || FileStorageProviderEnum.LOCAL;
        } else {
