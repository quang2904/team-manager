...
import { IPagination, IWarehouseProduct, IWarehouseProductCreateInput, IWarehouseProductVariant } from 'contracts';
...
export class WarehouseProductService extends TenantAwareCrudService<WarehouseProduct> {
  ...
  async createWarehouseProductBulk(
    ...
    let result: any = await this.warehouseProductRepository.save(warehouseProductArr);
