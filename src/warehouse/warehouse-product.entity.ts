import { Entity, ManyToOne, JoinColumn, Column, OneToMany, RelationId, Index } from 'typeorm';
import { IProductTranslatable, IWarehouse, IWarehouseProduct, IWarehouseProductVariant } from 'contracts';
