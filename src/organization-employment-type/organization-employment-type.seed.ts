import { GenericEmploymentTypes, IEmployee, IOrganization, ITenant } from 'contracts';
...
export const seedDefaultEmploymentTypes = async (
  ...
  const employmentTypes: OrganizationEmploymentType[] = Object.values(GenericEmploymentTypes).map((name) => {
