...
import { ICandidateExperience, IPagination, PermissionsEnum } from 'contracts';
...
export class CandidateExperienceController extends CrudController<CandidateExperience> {
  ...
  async pagination(@Query() params: PaginationParams<CandidateExperience>): Promise<IPagination<ICandidateExperience>> {
