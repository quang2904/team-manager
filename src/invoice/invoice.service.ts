...
import { IInvoice, IOrganization, LanguagesEnum } from 'contracts';
...
export class InvoiceService extends TenantAwareCrudService<Invoice> {
  ...
  async generateInvoicePdf(invoiceId: string, language: string) {
    ...
    const translatedText = {
      ...
      quantity: await this.i18n.translate('USER_ORGANIZATION.INVOICES_PAGE.INVOICE_ITEM.QUANTITY', { lang: language }),
      ...
      discountType: await this.i18n.translate('USER_ORGANIZATION.INVOICES_PAGE.DISCOUNT_TYPE', { lang: language }),
      ...
      terms: await this.i18n.translate('USER_ORGANIZATION.INVOICES_PAGE.INVOICES_SELECT_TERMS', { lang: language }),
  ...
  async generateInvoicePaymentPdf(invoiceId: string, language: string) {
    ...
    const translatedText = {
      ...
      recordedBy: await this.i18n.translate('USER_ORGANIZATION.INVOICES_PAGE.PAYMENTS.RECORDED_BY', { lang: language }),
      ...
      paymentsForInvoice: await this.i18n.translate('USER_ORGANIZATION.INVOICES_PAGE.PAYMENTS.PAYMENTS_FOR_INVOICE', {
        lang: language,
      }),
      dueDate: await this.i18n.translate('USER_ORGANIZATION.INVOICES_PAGE.DUE_DATE', { lang: language }),
      totalValue: await this.i18n.translate('USER_ORGANIZATION.INVOICES_PAGE.INVOICE_ITEM.TOTAL_VALUE', {
      ...
      totalPaid: await this.i18n.translate('USER_ORGANIZATION.INVOICES_PAGE.PAYMENTS.TOTAL_PAID', { lang: language }),
