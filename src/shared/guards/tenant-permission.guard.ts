...
import { isNotEmpty, PERMISSIONS_METADATA, removeDuplicates } from 'common';
...
export class TenantPermissionGuard extends TenantBaseGuard implements CanActivate {
  constructor(protected readonly _reflector: Reflector, private readonly _tenantService: TenantService) {
    super(_reflector);
  }
