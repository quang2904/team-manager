...
import { FileStorageProviderEnum, IScreenshot, PermissionsEnum, UploadedFile } from 'contracts';
    ...
    LazyFileInterceptor('file', {
      storage: () => {
        return new FileStorage().storage({
          dest: () =>
            path.join('screenshots', moment().format('YYYY/MM/DD'), RequestContext.currentTenantId() || uuid()),
          prefix: 'screenshots',
        });
      },
    }),
