import { Entity, Column, RelationId, ManyToOne, OneToMany, ManyToMany, JoinTable, Index } from 'typeorm';
import { ITimeSlot, ITimeSlotMinute, IActivity, IScreenshot, IEmployee, ITimeLog } from 'contracts';
