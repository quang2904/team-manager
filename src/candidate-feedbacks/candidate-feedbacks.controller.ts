...
import { PermissionsEnum, ICandidateFeedbackCreateInput, IPagination, ICandidateFeedback } from 'contracts';
...
export class CandidateFeedbacksController extends CrudController<CandidateFeedback> {
  ...
  async findByInterviewId(@Param('interviewId', UUIDValidationPipe) interviewId: string): Promise<CandidateFeedback[]> {
