...
import { IOrganizationSprint, IOrganizationSprintUpdateInput, IPagination } from 'contracts';
...
export class OrganizationSprintController extends CrudController<OrganizationSprint> {
  ...
  @Post()
  async create(@Body() body: OrganizationSprint, ...options: any[]): Promise<IOrganizationSprint> {
