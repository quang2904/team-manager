...
import { IIntegrationKeySecretPairInput, IIntegrationTenant, PermissionsEnum } from 'contracts';
...
export class IntegrationAIController {
   ...
   */
  @Post()
  async create(@Body() input: IIntegrationKeySecretPairInput): Promise<IIntegrationTenant> {
