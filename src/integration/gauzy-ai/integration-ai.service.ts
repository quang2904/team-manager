...
import { IIntegrationKeySecretPairInput, IIntegrationTenant, IntegrationEnum } from 'contracts';
...
export class IntegrationAIService {
  ...
  constructor(private readonly _commandBus: CommandBus, private readonly _integrationService: IntegrationService) {}
   ...
   * @returns
   */
  async create(input: IIntegrationKeySecretPairInput): Promise<IIntegrationTenant> {
    try {
