...
import { OctokitService } from 'plugins/integration-github';
import {
...
import { isNotEmpty, sleep } from 'common';
...
export class GithubSyncService {
  ...
  public async syncAutomationIssue(input: IGithubAutomationIssuePayload) {
    ...
    try {
      ...
      const projects: IOrganizationProject[] = await this._organizationProjectService.getProjectsByGithubRepository(
        repository.id,
        {
          organizationId,
          tenantId,
