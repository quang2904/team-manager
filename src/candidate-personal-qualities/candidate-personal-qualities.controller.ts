...
import { RolesEnum, ICandidatePersonalQualities, IPagination, ICandidatePersonalQualitiesCreateInput } from 'contracts';
...
export class CandidatePersonalQualitiesController extends CrudController<CandidatePersonalQualities> {
  ...
  @Roles(RolesEnum.CANDIDATE, RolesEnum.SUPER_ADMIN, RolesEnum.ADMIN)
  @Delete('bulk/:id')
  async deleteBulk(@Param('id', UUIDValidationPipe) id: string, @Query('data', ParseJsonPipe) data: any): Promise<any> {
