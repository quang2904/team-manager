...
import { IOrganization, ITenant, IUser, IUserOrganization, RolesEnum } from 'contracts';
...
export class UserOrganizationService extends TenantAwareCrudService<UserOrganization> {
  ...
  private async _addUserToAllOrganizations(userId: IUser['id'], tenantId: ITenant['id']): Promise<IUserOrganization[]> {
