...
import { IIntegrationEntitySetting, IIntegrationTenant, IPagination, PermissionsEnum } from 'contracts';
...
export class IntegrationEntitySettingController {
  ...
  async updateIntegrationEntitySettingByIntegration(
    ...
    return await this._commandBus.execute(new IntegrationEntitySettingUpdateCommand(integrationId, entity));
  }
}
