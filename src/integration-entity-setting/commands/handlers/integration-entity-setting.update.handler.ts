...
import { IIntegrationEntitySetting } from 'contracts';
...
export class IntegrationEntitySettingUpdateHandler implements ICommandHandler<IntegrationEntitySettingUpdateCommand> {
  constructor(
    private readonly _integrationEntitySettingService: IntegrationEntitySettingService,
    private readonly _integrationTenantService: IntegrationTenantService,
  ) {}

  public async execute(command: IntegrationEntitySettingUpdateCommand): Promise<IIntegrationEntitySetting[]> {
