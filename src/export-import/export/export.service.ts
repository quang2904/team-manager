  ...
  private async registerCoreRepositories() {
    this.repositories = [
      ...
      },
      {
        ...
        relations: [{ joinTableName: 'employee_job_preset' }, { joinTableName: 'tag_employee' }],
      },
      {
      ...
      },
      {
        ...
        relations: [{ joinTableName: 'equipment_shares_employees' }, { joinTableName: 'equipment_shares_teams' }],
      },
      {
      ...
      },
      {
        ...
        relations: [{ joinTableName: 'organization_contact_employee' }, { joinTableName: 'tag_organization_contact' }],
      },
      {
      ...
      },
      {
        ...
        relations: [{ joinTableName: 'organization_project_employee' }, { joinTableName: 'tag_organization_project' }],
      },
      {
      ...
      },
      {
        ...
        relations: [{ joinTableName: 'tag_proposal' }],
      },
      {
      ...
      },
      {
        ...
        relations: [{ joinTableName: 'task_employee' }, { joinTableName: 'task_team' }, { joinTableName: 'tag_task' }],
      },
      {
