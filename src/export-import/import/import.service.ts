...
import { isFunction, isNotEmpty } from 'common';
  ...
  private async registerCoreRepositories() {
    this.repositories = [
      ...
      },
      {
        ...
        isCheckRelation: true,
        foreignKeys: [{ column: 'roleId', repository: this.roleRepository }],
      },
      {
      ...
      },
      {
        ...
        isCheckRelation: true,
        foreignKeys: [{ column: 'userId', repository: this.userRepository }],
      },
      ...
      },
      {
        ...
        isCheckRelation: true,
        foreignKeys: [{ column: 'organizationContactId', repository: this.organizationContactRepository }],
      },
      {
        repository: this.organizationSprintRepository,
        isCheckRelation: true,
        foreignKeys: [{ column: 'projectId', repository: this.organizationProjectRepository }],
      },
      {
      ...
      },
      {
        ...
        isCheckRelation: true,
        foreignKeys: [{ column: 'reportId', repository: this.reportRepository }],
      },
      {
      ...
      },
      {
        ...
        isCheckRelation: true,
        foreignKeys: [{ column: 'candidateId', repository: this.candidateRepository }],
      },
      {
      ...
      },
      {
        ...
        isCheckRelation: true,
        foreignKeys: [{ column: 'interviewId', repository: this.candidateInterviewRepository }],
      },
      {
      ...
      },
      {
        ...
        isCheckRelation: true,
        foreignKeys: [{ column: 'employeeId', repository: this.employeeRepository }],
      },
      {
       ...
       */
      {
        ...
        isCheckRelation: true,
        foreignKeys: [{ column: 'featureId', repository: this.featureRepository }],
      },
      {
       ...
       */
      {
        ...
        isCheckRelation: true,
        foreignKeys: [{ column: 'leadId', repository: this.employeeRepository }],
      },
      {
      ...
      },
      {
        ...
        isCheckRelation: true,
        foreignKeys: [{ column: 'integrationId', repository: this.integrationTenantRepository }],
      },
      {
      ...
      },
      {
        ...
        isCheckRelation: true,
        foreignKeys: [{ column: 'integrationEntitySettingId', repository: this.integrationEntitySettingRepository }],
      },
      /*
      ...
      },
      {
        ...
        isCheckRelation: true,
        foreignKeys: [{ column: 'pipelineId', repository: this.pipelineRepository }],
      },
      {
      ...
      },
      {
        ...
        isCheckRelation: true,
        foreignKeys: [{ column: 'referenceId', repository: this.productCategoryRepository }],
      },
      {
      ...
      },
      {
        ...
        isCheckRelation: true,
        foreignKeys: [{ column: 'referenceId', repository: this.productTypeRepository }],
      },
      {
      ...
      },
      {
        ...
        isCheckRelation: true,
        foreignKeys: [{ column: 'groupId', repository: this.productOptionGroupRepository }],
      },
      {
        repository: this.productOptionTranslationRepository,
        isCheckRelation: true,
        foreignKeys: [{ column: 'referenceId', repository: this.productOptionRepository }],
      },
      {
        repository: this.productOptionGroupTranslationRepository,
        isCheckRelation: true,
        foreignKeys: [{ column: 'referenceId', repository: this.productOptionGroupRepository }],
      },
      {
      ...
      },
      {
        ...
        isCheckRelation: true,
        foreignKeys: [{ column: 'referenceId', repository: this.productRepository }],
      },
      {
       ...
       */
      {
        ...
        isCheckRelation: true,
        foreignKeys: [{ column: 'approvalPolicyId', repository: this.approvalPolicyRepository }],
      },
      {
      ...
      },
      {
        ...
        isCheckRelation: true,
        foreignKeys: [{ column: 'policyId', repository: this.timeOffPolicyRepository }],
      ...
      },
      {
        ...
        isCheckRelation: true,
        foreignKeys: [{ column: 'timeSlotId', repository: this.timeSlotRepository }],
      },
      {
