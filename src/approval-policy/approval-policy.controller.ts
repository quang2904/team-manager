import { PermissionsEnum, IPagination, IApprovalPolicy, IListQueryInput, IRequestApprovalFindInput } from 'contracts';
import {
  Query,
  HttpStatus,
  UseGuards,
...
export class ApprovalPolicyController extends CrudController<ApprovalPolicy> {
  constructor(private readonly approvalPolicyService: ApprovalPolicyService, private readonly commandBus: CommandBus) {
