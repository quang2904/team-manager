...
import { RolesEnum, ICandidateTechnologies, IPagination } from 'contracts';
...
export class CandidateTechnologiesController extends CrudController<CandidateTechnologies> {
  ...
  @Post('bulk')
  async createBulkCandidateTechnoglies(@Body() body: any): Promise<ICandidateTechnologies[]> {
  ...
  @Roles(RolesEnum.CANDIDATE, RolesEnum.SUPER_ADMIN, RolesEnum.ADMIN)
  @Put('bulk')
  async updateBulkCandidateTechnoglies(@Body() body: ICandidateTechnologies[]): Promise<ICandidateTechnologies[]> {
