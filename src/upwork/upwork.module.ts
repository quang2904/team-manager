...
import { UpworkJobService, UpworkOffersService, UpworkReportService } from 'plugins/integration-upwork';
...
@Module({
  imports: [
    RouterModule.forRoutes([{ path: '/integrations/upwork', module: UpworkModule }]),
