...
import { IPagination, IProductVariant, IVariantCreateInput } from 'contracts';
...
export class ProductVariantController extends CrudController<ProductVariant> {
  constructor(private readonly productVariantService: ProductVariantService, private readonly commandBus: CommandBus) {
