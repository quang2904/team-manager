...
import { BillingInvoicingPolicyEnum, IOrganization, ITenant } from 'contracts';
      ...
      for await (const productCategory of productCategories) {
        ...
        for await (const product of products) {
          ...
          for (let i = 0; i < numberOfVariantPerProduct; i++) {
            ...
            productVariant.billingInvoicingPolicy = faker.helpers.arrayElement(Object.keys(BillingInvoicingPolicyEnum));
